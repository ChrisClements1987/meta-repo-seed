...
This project uses standardized templates to ensure consistency and quality.

**Templates are located in `.github/` directory:**
- `.github/ISSUE_TEMPLATE/` - Issue templates (feature, bug, etc.)
- `.github/pull_request_template.md` - Pull request template

**When creating issues or PRs, GitHub automatically:**
- Presents available templates
- Pre-fills required sections
- Ensures all necessary context is provided

**For template updates:**
- Templates are version-controlled like code
- Changes require PR and review
- Keep templates aligned with this workflow document

**Key template sections align with workflow:**
- Definition of Ready (Section 8.C)
- Definition of Done (Section 8.D)
- Documentation categories (Section 8.D)
- Business validation requirements (throughout)
