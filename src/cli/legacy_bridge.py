...
For more information: https://github.com/ChrisClements1987/meta-repo-seed
    ...
    legacy_parser.add_argument(
        "--project", type=str, help="Project name (default: auto-detect)"
    )
    legacy_parser.add_argument(
        "--username", type=str, help="GitHub username (default: auto-detect)"
    )
    legacy_parser.add_argument(
    ...
    legacy_parser.add_argument(
        "--save-config", type=Path, help="Save configuration to file"
    )
    legacy_parser.add_argument(
        "--list-configs", action="store_true", help="List available configurations"
    )
    legacy_parser.add_argument(
        "--template-path", type=Path, help="Custom template directory path"
    )
