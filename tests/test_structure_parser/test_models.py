...
from src.structure_parser.models import StructureData, ValidationError, ValidationResult
...
class TestStructureData:
        ...
        data = {
            ...
            "structure": {
                "cloud-storage": {
                    ...
                    "architecture": {"principles": ["principles.md"], "adr": []},
                },
                "meta-repo": {
                    "governance": {
                    ...
                    "automation": {"scripts": ["initialize-repo.py"]},
                },
                "core-services": {
                    "service1": ["main.py", "config.py"],
                    "service2": {"src": ["app.py"], "tests": ["test-app.py"]},
                },
            },
        }
    ...
    def test_get_directory_files(self, sample_structure_data):
        ...
        strategy_files = sample_structure_data.get_directory_files(
        ...
        governance_files = sample_structure_data.get_directory_files(
        ...
        nonexistent_files = sample_structure_data.get_directory_files(
            "nonexistent/path"
        )
...
class TestValidationError:
    ...
    def test_validation_error_without_line_number(self):
        ...
        error = ValidationError(
            message="Test error", path="test.field", error_code="ERROR"
        )
