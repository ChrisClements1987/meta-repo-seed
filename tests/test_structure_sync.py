...
class TestFileTemplate(unittest.TestCase):
    ...
    def test_file_template_creation(self):
        ...
        template = FileTemplate(
            path="test.txt", content="Test content", template_vars={"var": "value"}
        )
    ...
    def test_checksum_calculation(self):
        ...
        template1 = FileTemplate(
            path="test.txt", content="Test content", template_vars={}
        )
        ...
        template3 = FileTemplate(
            path="test.txt", content="Different content", template_vars={}
        )
...
class TestDirectoryStructure(unittest.TestCase):
    ...
    def test_directory_structure_creation(self):
        ...
        subdirs = [DirectoryStructure("subdir1", "path/subdir1", [], [], {})]
    ...
    def test_to_dict_and_from_dict(self):
        ...
        files = [FileTemplate("file1.txt", "content1", {})]
