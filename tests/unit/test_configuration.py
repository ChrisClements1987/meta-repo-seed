...
class TestConfigurationClass:
    ...
    def test_from_dict_partial_config(self):
        ...
        data = {"project_name": "partial-project", "dry_run": True}
...
class TestConfigurationFileSaving:
    ...
    def test_save_yaml_file(self, temp_dir):
        ...
        config = Configuration(
            project_name="yaml-project", github_username="yaml-user", dry_run=True
        )
    ...
    def test_save_json_file(self, temp_dir):
        ...
        config = Configuration(
            project_name="json-project", github_username="json-user", dry_run=False
        )
...
class TestConfigurationPathHandling:
    ...
    def test_path_normalization(self):
        ...
        data = {"templates_dir": "/path/to/../templates", "base_path": "/path/to/base/"}
    ...
    def test_relative_path_handling(self, temp_dir):
        ...
        with patch("pathlib.Path.cwd", return_value=temp_dir):
            data = {"templates_dir": "./templates", "base_path": "../parent"}
