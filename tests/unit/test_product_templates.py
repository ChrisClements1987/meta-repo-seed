...
from generator import ProductTemplateGenerator, ProductTemplateRegistry, TemplateConfig
...
class TestProductTemplateRegistry(unittest.TestCase):
    ...
    def test_get_templates_by_deployment_target(self):
        ...
        vercel_templates = ProductTemplateRegistry.get_templates_by_deployment_target(
            "vercel"
        )
...
class TestProductTemplateGenerator(unittest.TestCase):
    ...
    def test_template_variable_substitution(self):
        ...
        variables = {"PRODUCT_NAME": "my-app", "CURRENT_DATE": "2025-01-01"}
