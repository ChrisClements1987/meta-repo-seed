...
class TestTemplateContentProcessing:
    ...
    def test_multiple_same_variable_replacement(self, sample_replacements):
        ...
        template_content = (
            "{{PROJECT_NAME}} is a great project. {{PROJECT_NAME}} rules!"
        )
...
class TestFileTemplateCreation:
    ...
    def test_create_file_from_template_success(
    ...
    def test_create_file_empty_template(
        self, temp_dir, mock_templates_dir, sample_replacements
    ):
    ...
    def test_create_file_overwrite_existing(
        self, temp_dir, mock_templates_dir, sample_replacements
    ):
    ...
    def test_create_file_large_template(
        self, temp_dir, mock_templates_dir, sample_replacements
    ):
...
class TestTemplateFileHandling:
    ...
    def test_template_file_encoding_handling(
        self, temp_dir, mock_templates_dir, sample_replacements
    ):
    ...
    def test_template_file_with_different_line_endings(
        self, temp_dir, mock_templates_dir, sample_replacements
    ):
...
class TestTemplateIntegrationWithRepoSeeder:
    ...
    def test_template_directory_discovery(self, temp_dir):
        ...
        (templates_dir / "readme.template").write_text(
            "# {{PROJECT_NAME}}\n\nBy {{GITHUB_USERNAME}}"
        )
    ...
    def test_template_processing_with_seeder_replacements(
        self, temp_dir, mock_templates_dir
    ):
